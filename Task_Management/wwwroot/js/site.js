...
$(document).ready(function () {
    ...
    $('.toggleBtn').on('click', function () {
        const index = $(this).closest('.taskCard').data('index');

        $.ajax({
            url: `/home/toggle/${index}`,
            type: "POST",
            success: function () {
    ...
    $('.deleteBtn').on('click', function () {
        indexToBeDeleted = $(this).closest('.taskCard').data('index');
    ...
    confirmedBtn.addEventListener("click", () => {
        $.ajax({
            url: `/home/delete/${indexToBeDeleted}`,
            type: "POST",
            success: function () {
